...
class atomInputNumberForm extends StatefulWidget {
  final TextEditingController controllerInput;
  final String textInput;
  final Icon icon;
  const atomInputNumberForm(
      {super.key,
      required this.controllerInput,
      required this.textInput,
      required this.icon});
  ...
  @override
  State<atomInputNumberForm> createState() => _atomInputNumberFormState();
}

class _atomInputNumberFormState extends State<atomInputNumberForm> {
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 400.0,
