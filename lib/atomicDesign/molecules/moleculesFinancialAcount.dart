...
class _moleculesFinancialAcountState
    extends State<moleculesFinancialAcount> {
  @override
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                              '¿Tienes una cuenta bancaria?', style: styleFinancialActivity.textWhite, textAlign: TextAlign.center),
                          SizedBox(height: 15.0),
                          Center(
                            child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: valueSiAcount ? Color(0xffFBB03B) : Color(0xff0095CD),
                                        border: Border.all(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(5.0),
                                        color: valueNoAcount ? Color(0xffFBB03B) : Color(0xff0095CD),
                                        border: Border.all(
                                          color: Color(0xffffffff)
                                        )
                                      ),
  ...
  Widget build(BuildContext context) {
    ...
    child: Center(
      child: Column(
        ...
        children: [
          SizedBox(height: 15.0),
          Text('¿Con qué entidad?', style:  styleFinancialActivity.textBlue, textAlign: TextAlign.center),
          SizedBox(height: 15.0),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
  ...
  Widget build(BuildContext context) {
    ...
    child: Center(
      child: Column(
        ...
        children: [
          SizedBox(height: 15.0),
          Text('¿Necesitas orientación para tenerla?', style:  styleFinancialActivity.textBlue, textAlign: TextAlign.center),
          SizedBox(height: 15.0),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5.0),
                      color: valueSiNeedsHelpAcount ? Color(0xff0095CD) : Color(0xffffffff),
                      border: Border.all(
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5.0),
                      color: valueNoNeedsHelpAcount ? Color(0xff0095CD) : Color(0xffffffff),
                      border: Border.all(
                        color: Color(0xff707070)
                      )
                    ),
